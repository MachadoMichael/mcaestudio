...
import conceptImage from "../../photos/concept.webp"
import { Info } from "../../components/photo-info/info.js"
import { LazyLoadImage } from 'react-lazy-load-image-component'

export const Concept = () => {
  return <div className="concept-container">
    <Navbar />
    <section className="concept-content">
      <div className="concept-image">
        <LazyLoadImage className='concept-photo' src={conceptImage} alt="concept" />
      ...
      <div className="concept-text-box">
        ...
        <div id='concept-writer'>Lu de Moraes</div>
